...
public class FFInventory : MonoBehaviour
{
    /// <summary>
	...
	public GameObject inactiveItem1;
	...
	private void Start()
    {
        ...
        if (PlayerPrefs.HasKey("FFinventory"))
        {
          LoadSavedInventory();
    ...
    {
        jsonString = PlayerPrefs.GetString("FFinventory");
    ...
    private SlotInfo FindSuitableSlot(int itemid)
    {
        ...
        {
            /*
            if (slotInfo.itemId == itemid && slotInfo.amount < slotInfo.MaxAmount && !slotInfo.isEmpty && itemDataBase.FindItemInItemDataBase(itemid).isStackable)
            {
                return slotInfo;
            }*/
	...
	public void SetItemObjectActive() /// para intems que deben aparecer en escena luego que otro item es descubierto
	{
		SlotInfo slotInfo = FindItemInInventory(9);
		if (slotInfo != null)
		{
			if(inactiveItem1!=null)
			inactiveItem1.SetActive(true);
		}
	}
    ...
    public void SaveInventory()
    {
        ...
        PlayerPrefs.SetString("FFinventory", jsonString);
    }
