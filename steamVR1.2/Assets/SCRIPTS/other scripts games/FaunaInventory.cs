...
public class FaunaInventory : MonoBehaviour
{
    /// <summary>
	...
	private void Start()
    {
       // PlayerPrefs.DeleteAll();
        ...
        if (PlayerPrefs.HasKey("Faunainventory"))
        {
          LoadSavedInventory();
        }
        else
    ...
    {
        jsonString = PlayerPrefs.GetString("Faunainventory");
    ...
    public void SaveInventory()
    {
        ...
        PlayerPrefs.SetString("Faunainventory", jsonString);
    }
